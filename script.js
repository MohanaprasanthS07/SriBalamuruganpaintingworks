...
// JavaScript to control loader visibility
window.addEventListener('load', () => {
  // Add a delay of 4 seconds before hiding the loader
  setTimeout(() => {
    // Add the 'loaded' class to hide the loader after 4 seconds
    document.body.classList.add('loaded');
  }, 3000); // 4 seconds delay (4000 milliseconds)
});
